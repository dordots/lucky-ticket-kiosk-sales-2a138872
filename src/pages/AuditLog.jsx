...
const actionConfig = {
  ...
  cancel_sale: { label: "ביטול מכירה", icon: ShoppingCart, color: "bg-orange-100 text-orange-700" },
  ...
  reduce_inventory: { label: "הפחתת מלאי", icon: Package, color: "bg-red-100 text-red-700" },
