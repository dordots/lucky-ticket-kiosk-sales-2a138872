...
- ✅ **הסרת רובריקת "סוג הכרטיס"**
  - סטטוס: הושלם
  - מימוש: השדה `ticket_category` הוסר מ-formData, משתמש ב-'custom' כברירת מחדל
  - קובץ: `src/pages/Inventory.jsx`

### 3. גודל תמונות
- ✅ **3 כרטיסים בשורה במקום כרטיס תחת כרטיס**
  - סטטוס: הושלם
  - מימוש: שונה ל-`grid-cols-3` בכל המקומות
  - קבצים:
    - `src/pages/Inventory.jsx` - ✅
    - `src/pages/Onboarding.jsx` - ✅
    - `src/pages/SellerPOS.jsx` - ✅ (שונה מ-4-5 ל-3)
    - `src/components/pos/TicketGrid.jsx` - ✅ (שונה מ-4-5 ל-3)
...
5. הרשאות - הושלם
6. מלאי קריטי - הושלם
7. הסרת שדה "סוג הכרטיס" - הושלם

### ⚠️ חלקי (1/17)
1. ביצועים - יש אופטימיזציות בסיסיות, ייתכן שצריך שיפורים
